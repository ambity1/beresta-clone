...
<head>
    ...
    <title>{{$category->name}} | Береста</title>
...
<main>
    @include('components.category.contentHeader')
    <div class="categoryPage container d-flex flex-row justify-content-between align-items-start">
        @include('components.category.filters')
        <div>
            @include('components.category.sort')
            @include('components.category.products')
            @include('components.category.pagination')
        </div>
    </div>
</main>
